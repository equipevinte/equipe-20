...
struct DiceSkinRepository  {
    static let PacoteDefault = DiceSkin(preco: 0,
                                 skinImages: "PacoteDefault",
                                 nome: "Pacote Default",
                                 comprado: false,
                                 equipado: true,
    ...
    static let PacoteMusgo = DiceSkin(preco: 1,
    ...
    static let PacoteGalatico = DiceSkin(preco: 1,
    ...
    static let PacoteOtimista =   DiceSkin(preco: 1,
    ...
    static let PacoteFlorest = DiceSkin(preco: 1,
